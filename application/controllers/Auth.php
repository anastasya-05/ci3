...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
      ...
      if ($this->form_validation->run() == false) {
        ...
        //function untuk mengirim verifikasi ke mall
        private function _sendEmail($token, $type)
        {
            ...
            $config['smtp_user'] = 'sherlyana360@gmail.com';//isi dgn email yg baru dibuat
            $config['smtp_pass'] = 'fpxxpijfgankuked';
            $config['smtp_port'] = 465;
            $config['mailtype'] = 'html';
            $config['charset'] = 'uf-8';
            $this->email->initialize($config);
            $this->email->set_newline("\r\n");
            $this->email->from('sherlyana360@gmail.com', 'web Programing SMKN8Jember');
