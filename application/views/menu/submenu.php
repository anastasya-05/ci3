    ...
    <div class="row">
        <div class="col-lg-">
            ...
            <!-- akhir pesan eror -->
                ...
                data-toggle="modal" data-target="#Modal">Add Menu</a>
                <!-- Tabel -->
                    ...
                    <?php foreach ($Submenu as $sm) : ?>
                        <tr>
                                ...
                                <td>
                                    ...
                                    <butoon onclick="hapuSubmenu('<?= base_url('menu/hapus/'). $sm['id'] ?>')"
...
aria-labellaedby="newMenuModallabel" aria-hidden="true">
...
aria-labellaedby="exampleModalLabelsubedit" aria-hidden="true">
